...
<body class="sidebar-mini skin-purple" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header">
            <a href="#" class="logo">
                <span class="logo-mini"><b>Neqabtaasy</b></span>
                <span class="logo-lg">Neqasaabty</span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                    {{-- <div class="dropdown-divider"></div> --}}
                    {!! Form::model('logout',['method'=>'POST','route'=>'logout']) !!} <button class="dropdown-item" type="submit"><i class="ft-power"></i> sa;las;la   Logout</button>{!! Form::close() !!}
                  </div>
        ...
        <footer class="main-footer text-center">
            <strong>Neqabty &copy;</strong> all rights reserved
        </footer>
