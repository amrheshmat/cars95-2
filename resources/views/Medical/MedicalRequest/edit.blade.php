...
@section('content')
                    ...
                    @if($model['status'] == 1)
                       <table class="table">
                         ...
                         <tr>
                           <td>صورة الموافقة </td>
                           <td>
                               <a href="{{$model->approval_image}}" width="50%" > download </a>
                             </td>
                         </tr>
                         <tr>
                           <td>تعليق</td>
  ...
  <script type="text/javascript">
    $( document ).ready(function() {  $(function () { $('select').select2();})});
      ...
      // alert($('.provider_type_id').val());
        //   alert($('.user_provider_type_id').val());
           if($('.provider_type_id').val() == $('.user_provider_type_id').val()){
              $('.medical_item').show();
           }else[
               $('.medical_item').hide();
           ]
