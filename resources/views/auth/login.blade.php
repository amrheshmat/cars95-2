                ...
                <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                     {{ csrf_field() }}
                        <div class="form-group">
                            <div class="col-xs-12">
                            <input id="email" type="text" class="form-control" name="username" placeholder="البريد الإلكترونى" value="{{ old('username') }}" required autofocus>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 font-14">
                                <div class="checkbox checkbox-primary pull-left p-t-0">
                                    <a href="#" for="checkbox-signup"> اعاده تعيين كلمه المرور </a>
                                </div> 
                            </div>
                        </div>
