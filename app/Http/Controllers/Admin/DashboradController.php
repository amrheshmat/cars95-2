...
class DashboradController extends Controller
{
    ...
    {        
        ...
        if ($user->hasRole('superadmin|medical|syndicate.admin|provider|superprovider')) 
        { 
        ...
        return view('Dashboard.admin',compact('medicalActions_users','medical_requests_latest','medicalProviders_counts',/*'MedicalRequest',*//*'Trip','News',*/'medical'));
